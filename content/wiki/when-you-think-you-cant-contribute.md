...
updated : 2020-04-06 20:52:44 +0900
tags    : 
parent  : 
---
...
# 이게 왜 문제에요? 
  ...
  대단히 똑똑하고 빠르게 움직이는 사람들이 있다고해서 좋은 조직인 것은 아닙니다. 적절한 온보딩과 피드백이 있다면 더욱 효과적으로 일할 수 있습니다. 이런 것들이 있고, 이런 기능을 하며, 당신은 이런 역할을 하게 될 거다. 라는 얘기를 듣는 것과, 그냥 그 팀에 던져져 '질문할 수 있는 타이밍'을 찾는 사람이 되는 것. 그리고 2주에 한번씩 매니저와 면담해서 방향을 정할 수 있는 기회가 마련되어있는 팀과, 겨우 평가 기간에만 면담하는 팀은 확실히 다르니까요.
  저는 특히나 자기 효능감이 요동치는 사람이어서, 팀에서는 '자기 Pull Request가 안올라와 있으면 불안해하는 신입' 정도로 통하고 있습니다. 앗, 이런 평가는 두번의 인턴 평가와는 조금 다릅니다. 
  인턴시절에는 명확한 프로젝트가 있고요, 목적이 있습니다. 상대적으로 짧은 기간안에 프로젝트를 완성시키고, 그것을 발표합니다. 기능이 잘 동작하고 읽기 좋은 코드라면 좋은 평가를 받습니다. (팀프로젝트라면 협업시의 태도 등도 고려합니다.) 이걸로 어떤 마무리가 지어지고 성장 가능성이 괜찮은 새싹이라는 평가를 받습니다. 
  업무에 들어오니 다릅니다. 저에게 맡기기에는 프로젝트는 기한이 있고, 코딩 실력은 다른 사람보다 낮습니다.  공통 구조와 로직을 최대한 제공해서 기본적인 코드의 퀄리티를 보장해주지만, 창의적인 방법으로 스파게티를 짜옵니다. 이걸 지적하고 고치도록 기다려주는데 시간이 듭니다. 선배 개발자들은 조금 쉬운 컴포넌트만 맡깁니다. CRUD 나 다른 코드를 참고하여 금방 짤 수 있는 것들이 대상이 됩니다. 쉬운 일은 금방 없어지고, 쉬운 걸 조금씩밖에 하지 못한 저는 우울에 빠집니다. 
  장황하게 적었지만 어쨌든 이런 경로로 저는 자기효능감 저하와 우울의 하강나선에 들어서곤 합니다. 이럴 때 도움이 된 일들을 몇가지 소개합니다.
