---
slug: "/2017-08-19/django-rest-framework01"
updated: 2020-03-09 14:21
title: Django로 REST API 서버 구축 튜토리얼 따라가기 1편
date: 2017-08-19
excerpt: "json을 보내보자"
tags: 
    - Django
...
하지만 Firebase는 상당히 느리죠. 체감할 정도로 `속도 이슈`가 발생했습니다.
...
ALTER ROLE <유저명> SET timezone TO 'UTC-9';
